...
import numpy as np
from conversion.sb3_to_sequential.sb3_to_sequential_converter import (
...
class TestEndToEndConversion(unittest.TestCase):
    ...
    def test_save_and_load_cycle(self):
        ...
        try:
            from conversion.sb3_to_sequential.sb3_to_sequential_converter import save_sequential_model
